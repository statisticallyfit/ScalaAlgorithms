...
public class TransitiveClosure {
    private DirectedDFS[] transClos;  // transClos[v] = reachable from v
    ...
    public TransitiveClosure(Digraph digraph) {
        transClos = new DirectedDFS[digraph.V()];
        for (int v = 0; v < digraph.V(); v++)
            transClos[v] = new DirectedDFS(digraph, v);
    }
