...
public class DijkstraSP {
     ...
     *
     * @param  edgeWeightedDigraph the edge-weighted digraph
     * @param  s the source vertex
     * @throws IllegalArgumentException if an edge weight is negative
     * @throws IllegalArgumentException unless 0 &le; <tt>s</tt> &le; <tt>V</tt> - 1
     */
    public DijkstraSP(EdgeWeightedDigraph edgeWeightedDigraph, int s) {
        for (DirectedEdge e : edgeWeightedDigraph.edges()) {
            if (e.weight() < 0)
        ...
        candidatesForRelax = new IndexMinPQ<Double>(edgeWeightedDigraph.V());
        ...
        assert check(edgeWeightedDigraph, s);
    }
    ...
    private boolean check(EdgeWeightedDigraph edgeWeightedDigraph, int s) {
        ...
        for (int w = 0; w < edgeWeightedDigraph.V(); w++) {
