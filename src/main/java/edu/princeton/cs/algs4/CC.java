 ...
 *  the <em>componentCount</em> operation determines the number of connected
 ...
 *  Afterwards, the <em>id</em>, <em>componentCount</em>, <em>connected</em>,
...
public class CC {
    ...
    private int[] size;         // note size[id] = number of vertices in given component
    private int componentCount;          // number of connected components note graph is connected if componentCount == 1
    ...
    // id[v] = component id number vertex v is in
    //
     ...
     * note steps: 1. first get vertex
     *             2. then find its component
     *             3. then return how many elements that component has.
     * @param  v the vertex
    ...
    // note made by me to make it easier to ask if whole graph is in one piece
    ...
    /**
     * note made by me
     * Returns array of queue<integer> objects that hold components
     */
    public Queue<Integer>[] getComponents() {
        Queue<Integer>[] components = (Queue<Integer>[]) new Queue[componentCount];
        int numVertices = marked.length;
    ...
    public static void main(String[] args) {
        ...
        int numConn = cc.count();
        StdOut.println(numConn + " components");

        // compute list of vertices in each connected component
        Queue<Integer>[] components = cc.getComponents();
        /*Queue<Integer>[] components = (Queue<Integer>[]) new Queue[numConn];
